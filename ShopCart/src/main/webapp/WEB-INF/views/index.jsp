...
<div class="container-fluid text-center">
  ...
  <div class="row">
    <div class="col-sm-4">
      ...
      <p>we deliver under 30 minutes</p>
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-heart"></span>
      <h4>LOVE</h4>
      <p>we care for our customers with amazing offers</p>
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-fire"></span>
      <h4>SERVE HOT</h4>
      <p>optimim quality is what that matters to us</p>
    </div>
    </div>
    <br><br>
  <div class="row">
    <div class="col-sm-4">
      ...
      <h4>FEEDBACK</h4>
      <p>we do take a feedback of every order to cope up with the standards</p>
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-phone"></span>
      <h4>APP
      </h4>
      <p>we are soon coming with our app!!!!</p>
    </div>
    <div class="col-sm-4">
